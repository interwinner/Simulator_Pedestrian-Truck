...
public class Traci_one : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        client.Gui.TrackVehicle("View #0", "veh0");
        ...
        client.Vehicle.SetSpeed("veh0", 0); //stops SUMO controlling player vehicle

        var V_cnt = client.Vehicle.GetIdCount().Content;
        
        //var idList= client.Vehicle.GetIdList().Content;
        List<string> idList = client.Vehicle.GetIdList().Content;

        var shape = client.Vehicle.GetPosition("veh0").Content;
        var angle = client.Vehicle.GetAngle("veh0").Content;
    ...
    private void FixedUpdate()
    {
        ...
        var newvehicles = client.Simulation.GetDepartedIDList("veh0").Content; //new vehicles this step
        var vehiclesleft = client.Simulation.GetArrivedIDList("veh0").Content; //vehicles that have left the simulation
         ...
         */
        client.Vehicle.MoveToXY("veh0", road, lane, (double) egoVehicle.transform.position.x,
